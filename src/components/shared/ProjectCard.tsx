...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <article className="group w-full">
      <a href={project.href} className="mx-auto block w-full max-w-[15.5rem]">
        <div className="rounded-[2.2rem] border-[2px] border-textPrimary bg-bgSecondary p-[0.35rem] shadow-[0_16px_30px_rgba(47,59,47,0.14)] transition duration-500 ease-general group-hover:-translate-y-1 group-hover:shadow-[0_22px_36px_rgba(47,59,47,0.2)]">
          ...
          >
            ...
            <div className="bg-gradient-to-b from-bgSecondary to-bgTertiary px-4 pb-4 pt-7">
              ...
              <p className="text-center text-base font-semibold leading-tight text-textPrimary">Live Product Preview</p>
              <p className="mt-1 text-center text-[12px] leading-relaxed text-textSecondary">Tap cards and modules to explore flows.</p>
            </div>
            ...
            <div className="border-y border-borderSubtle bg-bgTertiary px-4 py-3">
              ...
              <p className="mt-2 text-xs font-medium text-textPrimary">Tap to open product experience.</p>
            </div>

            <div className="mt-auto bg-bgSecondary px-4 py-4">
              <div className="rounded-md bg-textPrimary px-3 py-3 text-center">
                <p className="text-lg font-semibold leading-tight text-bgSecondary">Everything at your stop.</p>
              </div>
            </div>
          </div>
        </div>
      </a>
      <div className="mx-auto mt-4 w-full max-w-[15.5rem]">
        ...
        <a
          href={project.href}
          className="mt-4 inline-block text-sm uppercase tracking-[0.14em] text-textPrimary transition-colors hover:text-accent"
        >
          Explore Platform
        </a>
      </div>
